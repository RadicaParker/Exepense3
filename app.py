...
if not st.session_state.logged_in:
    ...
    if menu == "Expense Form":
        ...
        if not non_admin_df.empty:
            ...
            selected_approver = st.selectbox("Select approver", all_user_emails, index=approver_index, key="approver_update")
            selected_amoeba = st.selectbox("Select Amoeba / Department", amoeba_choices, index=amoeba_index, key="amoeba_update")
